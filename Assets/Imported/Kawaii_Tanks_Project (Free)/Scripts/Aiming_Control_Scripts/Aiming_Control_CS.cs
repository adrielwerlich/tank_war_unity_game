    ...
    public class Aiming_Control_CS : MonoBehaviour
    {
		...
		*/
        ...
        void Start()
        {
            ...
            //{
            //    // Your game is running in a WebGL environment
            //    Debug.Log("Running in WebGL environment.");
        ...
        void FixedUpdate()
        {
            ...
            //Debug.Log("aim control, targetTransform [1] => " + targetTransform);
            //Debug.Log("aim control, mode [2] => " + mode);
            ...
            { // Free aiming.
                ...
                //Debug.Log("aim control, target [3] => " + targetPosition);
            }
        }
        ...
        void Update_Target_Position()
        {
            ...
            //Debug.Log("aim control, target => " + targetPosition);
        }


        public void Switch_Mode()
        { // Called also from "Aiming_Control_Input_##_###".
            //Debug.Log("Aiming_Control switch mode => " + mode);
            switch (mode)
            {
        ...
        { // Called from "Aiming_Control_Input_##_###".
            ...
            //Debug.Log("*** aim control targetposition => " + targetPosition);
        }
