...
namespace ChobiAssets.KTP
{
    ...
    public class Fire_Control_CS : MonoBehaviour
    {
		...
		*/
        ...
        [Tooltip("Loading time. (Sec)")] public float reloadTime = 1.0f; // Referred to from "Reloading_Circle_CS".
        ...
        {
#if UNITY_WEBGL || !UNITY_ANDROID && !UNITY_IPHONE
        ...
        public void Fire(string source)
        {
            if (source.Equals("mouse0") && counter == 0) { counter++; return; }
