	...
	public class Turret_Control_CS : MonoBehaviour
	{
		...
		*/
        ...
        void FixedUpdate()
        {
            ...
            {
                Auto_Turn();
                //Debug.Log("turret control auto turn");
            }
            else
            {
                Manual_Turn();
                Debug.Log("turret control manual turn");
        ...
        void Auto_Turn()
        {
            ...
            float targetTurnRate = Mathf.Lerp(
                0.0f, 
                1.0f, 
                targetAngle / (rotationSpeed * Time.fixedDeltaTime + currentSlowdownAng)
                ) * sign;
            ...
            //Debug.Log("turret controller currentLocalAngles 2 => " + currentLocalAngles);
        }
        ...
        void Manual_Turn()
        {
            ...
            currentLocalAngles.y = angleY;
            thisTransform.localEulerAngles = currentLocalAngles;
            //Debug.Log("manual turn =>" + currentLocalAngles);
        }
